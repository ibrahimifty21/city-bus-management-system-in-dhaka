"""
Django settings for citybus project.
...
SECRET_KEY = 'django-insecure-l0$ywl=g@5ljh(37^3-rhe7bdm1*n4y(lolr!=b^euzj=ies7='
...
WSGI_APPLICATION = 'citybus.wsgi.application'
